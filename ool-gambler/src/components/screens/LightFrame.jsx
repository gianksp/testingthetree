...
function Bulb({ color, delay, duration }) {
    return (
        <span
            className="block h-3 w-3 shrink-0 rounded-full sm:h-4 sm:w-4"
            style={{
...
export default function LightFrame({ children, top = 14, side = 8 }) {
    const bulbs = useMemo(() => {
        const order = [];
